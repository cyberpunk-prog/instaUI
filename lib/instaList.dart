...
import 'package:instacopy/stories.dart';
import 'package:http/http.dart' as http;
import 'dog_create.dart';
...
class _InstaListState extends State<InstaList> {
  ...
  fetchData() async {
    ...
    dogs = Dog.fromJson(decodedJson);
    // var res1 = await http.get(url1);
    // var decodedJson1 = jsonDecode(res1.body);
    // quto = Qutoes.fromJson(decodedJson1[counter]);
    setState(() {});
    //print(res.body);
    print(dogs.url);
  }
          ...
          : Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                    "Liked by Believe_App, interns and 15 others",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ),
                ),
                Padding(
